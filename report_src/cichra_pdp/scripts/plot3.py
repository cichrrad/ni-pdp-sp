...
# -- G1: Čas běhu vs n --
plt.figure()
sns.lineplot(data=all_data, x='n', y='time', hue='impl', marker='o', errorbar=None)
plt.yscale('log')
...
plt.figure()
sns.barplot(data=speedup_melted, x='impl', y='speedup', errorbar=None)
...
plt.yscale('log')
sns.barplot(data=all_data, x='file', y='time', hue='impl', errorbar=None)
